...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If iniciado = True Then
            MessageBox.Show("El servicio se encuentra activo", "Facturas Factoring", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
    ...
    Sub leetext(ByVal ruta As String)
        ...
        If pasoesemisor And pasoesfactura Then
            ...
            Else
                ...
                If notificaError1 = "S" Then
                    EnviarMail(mailnotiicaError1, Cuerpo, "Error Factura Factory", "danielbustos86@gmail.com", dirErrorRFC1 + "\" + result)
        ...
        Else
            ...
            If notificaError1 = "S" Then
                EnviarMail(mailnotiicaError1, Cuerpo, "Error Factura Factory", "danielbustos86@gmail.com", dirErrorFormato1 + "\" + result)
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If iniciado = False Then
            MessageBox.Show("El servicio no se encuentra activo", "Facturas factoring", MessageBoxButtons.OK, MessageBoxIcon.Information)
            Exit Sub
    ...
    Function CARGARFC(ByVal FEC_EMI_CN As String, ByVal FEC_REC_CN As String, ByVal RUT_PROVEEDOR As String, ByVal NOM_PROVEEDOR As String, ByVal FOLIO As String, ByVal RUTEMISOR As String) As String
        ...
        table.SetValue("USER_FACTORING", "Recepcion_Factory")
    ...
    Sub EnviarMail(ByVal destinatarios As ArrayList, ByVal cuerpo As String, ByVal titulo As String, ByVal copia As String, ByVal adjunto As String)
        ...
        Try
            ...
            If adjunto <> "" Then
                Archivo = System.IO.Path.GetFileName(adjunto)
                Dim fInfo As New FileInfo(adjunto)
                Dim numBytes As Long = fInfo.Length
                Dim dLen As Double = Convert.ToDouble(fInfo.Length / 1000000)
                If (dLen < 5) Then
                    Dim fStream As New FileStream(adjunto, FileMode.Open,
                    FileAccess.Read)
                    Dim br As New BinaryReader(fStream)
                    DataArchivo = br.ReadBytes(Convert.ToInt32(numBytes))
                    br.Close()
            ...
            If adjunto <> "" Then
                requestSoapXML = requestSoapXML & "<Archivo>" + Archivo.ToString.Trim + "</Archivo>"
    ...
    Private Sub Form1_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        If e.CloseReason = CloseReason.UserClosing Then
            ...
            If (MessageBox.Show("Esta seguro que desea cerrar la aplicacion", "Factory", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes) Then
                GuardarList2()
                Exit Sub
            Else
                e.Cancel = True
